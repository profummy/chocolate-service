...
public class ChocolatePagedList extends PageImpl<ChocolateDto> implements Serializable {

    @JsonCreator(mode = JsonCreator.Mode.PROPERTIES)
    public ChocolatePagedList(@JsonProperty("content") List<ChocolateDto> content,
